...
namespace Elshaden\LaravelPlans\Tests;
...
class TestCase extends Testbench
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        // Set user model
        $app['config']->set('auth.providers.users.model', '\Elshaden\LaravelPlans\Tests\Models\User');
    ...
    {
        return ['Elshaden\LaravelPlans\LaravelPlansServiceProvider'];
    }
